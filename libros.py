...
número de páginas y la calificación que le damos entre 0 y 10.___
...
de libros. __
** Se pueden añadir libros que no existan (siempre que haya espacio)__
** eliminar libros por título o autor__
** mostrar por pantalla los libros con la mayor y menor calificación dada y, por último__
** mostrar un contenido de todo el conjunto.__
'''
